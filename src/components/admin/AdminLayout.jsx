...
import { LayoutDashboard, Package, ClipboardList, Star, ArrowLeft, ShieldAlert, Layers, Image as ImageIcon, Users as UsersIcon, ShieldCheck, ChevronDown, BarChart3, Contact, TicketPercent, Settings as SettingsIcon, ClipboardCheck, FileX, Languages, LayoutList, Compass } from "lucide-react";
...
const NAV = [
  ...
  { section: "home_sections", label: "Home sections", path: "/admin/home-sections", icon: LayoutList },
  { section: "navigation", label: "Navigation", path: "/admin/navigation", icon: Compass },
