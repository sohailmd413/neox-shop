...
// Consistent storefront category tile: fixed 4:3 aspect ratio, object-cover
// so every image fills edge-to-edge without distortion, and a bottom-up
// gradient behind the label so text stays legible on any image brightness.
// Identical sizing/cropping regardless of how many tiles are in the grid.
